This example show how a primary and secondary base configuration can be setup.  The only difference between the 2 deployments are the Redundancy system settings for the secondary hub.  This version 4.5 deployment can used by anyone.
